...
// Solo accesible a cuentas de tipo 'user'
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'user') {
    echo '<!DOCTYPE html><html lang="es"><head><meta charset="utf-8"><title>Acceso restringido</title></head><body>';
    echo '<p>Lo sentimos, esta sección está reservada a usuarios individuales. Si entraste como empresa, accede al panel correspondiente.</p>';
...
<head>
    ...
    <link rel="stylesheet" href="formulario_editar_usuario.css" /> <!-- ENLAZAMOS CON EL CSS DEL FORMULARIO -->
</head>
...
<body>
    <div id="contenedor">
        ...
        <main>
            <section class="formulario"> <!-- contenido con formulario -->
                ...
                <form action="../../controller/userController.php" autocomplete="on" method="get">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="col-izq">
                            ...
                            <input type="text" name="poblacion" id="poblacion" required required pattern="[A-Za-z]{3,}"
                                placeholder=""
                            ...
                            <button type="button" class="btn-submit">Eliminar Cuenta</button>
                        </div>
    ...
    <footer>
        <img src="../assets/logo_en_blanco.png" alt="logo">
